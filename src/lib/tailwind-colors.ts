// Source: https://tailwindcss.com/docs/colors version 4.1
...
type TailwindColors = {
  red: Record<ColorSteps, string>;
  orange: Record<ColorSteps, string>;
  amber: Record<ColorSteps, string>;
  yellow: Record<ColorSteps, string>;
  lime: Record<ColorSteps, string>;
  green: Record<ColorSteps, string>;
  emerald: Record<ColorSteps, string>;
  teal: Record<ColorSteps, string>;
  cyan: Record<ColorSteps, string>;
  sky: Record<ColorSteps, string>;
  blue: Record<ColorSteps, string>;
  indigo: Record<ColorSteps, string>;
  violet: Record<ColorSteps, string>;
  purple: Record<ColorSteps, string>;
  fuchsia: Record<ColorSteps, string>;
  pink: Record<ColorSteps, string>;
  rose: Record<ColorSteps, string>;
  slate: Record<ColorSteps, string>;
  gray: Record<ColorSteps, string>;
  zinc: Record<ColorSteps, string>;
  neutral: Record<ColorSteps, string>;
  stone: Record<ColorSteps, string>;
  black: string;
  white: string;
};
